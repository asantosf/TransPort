    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="#" method="post" name="guardarProductoForm"
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" id="cantMinima" name="cantMinima" class="form-control" min="0"
                                    required placeholder="Ej.: 10, 20, 30">
                            </div>
                        </div>
                        <br>
                        <div class="row">
